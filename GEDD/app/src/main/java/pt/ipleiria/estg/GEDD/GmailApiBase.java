 ...
 */
public class GmailApiBase extends ActionBarActivity{
    /**
    ...
    private static final String[] SCOPES = { GmailScopes.GMAIL_LABELS, GmailScopes.GMAIL_COMPOSE, GmailScopes.GMAIL_INSERT };
